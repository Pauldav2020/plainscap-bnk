                ...
                <form action="" id='login-form'>
                    ...
                    <div class="form-group">
                        <div class="form-login">
                            ...
                            <button type="submit" class="submit" id="login_submit"><span class="spinal"
                                    display="block!important"></span> Login</button>
                            <div class="links">
                                <a href="#"
                                    onclick="document.getElementById('modal-page').style.display ='block';">Forgot
                                    your
                                    password/UserID?</a>
                    ...
                    <div class="form-group">
                        <div class="column-container">
                            <div class="column">
                                <h5>Security Tips</h5>
                                <p>
                                    Please note that PCB Community Bank
