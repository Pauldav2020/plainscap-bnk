    ...
    <header>
        <nav>
            <div class="navigation-bar">
                <div class="bank-info">
                    <ul class="phone">
                        <li class="phone"><a href="<?=$phone_number?>">
                                <?=$phone_number?>
                            </a></li>
                        <li class="email"><a href="mailto:<?=$bank_display_email?>"><?=$bank_display_email?></a></li>
                    </ul>
                </div>
            </div>
            <div class="navigation-list">
                <div class="list-container">
                    ...
                    <ul class="list" id="nav-content" onclick="closed(event)">
                        ...
                        <li class="online"><a href="login"><i class="fa fa-lock rt-mega-menu-icon"></i>Online
                                Banking</a></li>
                    </ul>
                </div>
            </div>
