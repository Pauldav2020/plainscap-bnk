    ...
    <div class="footer-container">
        <div class="columns">
            <div class="col">
                ...
                <p>
                    Our relationships are built on trust that we build every day through every interaction. Our
                    employees are empowered to do the right
            ...
            <div class="col">
                ...
                <div class="col-last">
                    <ul>
                        <li><i class="fa-solid fa-location-dot"></i><a href="#">Victory Ave TX, USA</a></li>
                        <li><i class="fa-solid fa-phone"></i>(+1) 440 721</li>
                        <li><i class="fa-regular fa-envelope"></i><?=$bank_display_email?></li>
                    </ul>
                </div>
            </div>
        </div>
